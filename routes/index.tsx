...
function Index() {
  ...
  return (
    <>
      ...
      {/* Amazon US Trending Now */}
      <section aria-labelledby="trending-now-heading" className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-8">
        <a
          href={amazonTrendingNowUrl}
          target="_blank"
          rel="noopener noreferrer sponsored"
          aria-label="Trending Now — shop Amazon US trending products"
          className="group relative block overflow-hidden rounded-2xl border border-border bg-black shadow-elevated transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl"
        >
          <img
            src="/amazon-trending-now.svg"
            alt="Trending Now — discover trending products on Amazon US"
            width={1600}
            height={520}
            loading="eager"
            decoding="async"
            className="h-auto w-full transition-transform duration-700 group-hover:scale-[1.01]"
          />
          <span id="trending-now-heading" className="sr-only">Trending Now</span>
        </a>
      </section>
