...
/** Best-effort analytics: never block navigation or page rendering. */
...
export function trackAffiliateClick(productId?: string, path?: string): void {
  trackEvent({
