...
function Index() {
  ...
  return <>
    ...
    <section aria-labelledby="today-deal-heading" className="mx-auto max-w-7xl px-4 pt-10 sm:px-6 lg:px-8"><a href={amazonDealsUrl} target="_blank" rel="noopener noreferrer sponsored" aria-label="Today's Best Deal — open Amazon Deals" className="group relative block overflow-hidden rounded-2xl border border-border bg-black shadow-elevated"><img src="/amazon-todays-best-deal.svg" alt="Today's Best Deal — shop Amazon Deals" width={1600} height={520} loading="eager" decoding="async" className="h-auto w-full" /><span id="today-deal-heading" className="sr-only">Today's Best Deal</span></a></section>
    <section aria-labelledby="amazon-trending-now-heading" className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-8"><a href={amazonTrendingNowUrl} target="_blank" rel="noopener noreferrer sponsored" aria-label="Trending Now — shop Amazon US trending products" className="group relative block overflow-hidden rounded-2xl border border-border bg-black shadow-elevated"><img src="/amazon-trending-now.svg" alt="Trending Now — discover trending products on Amazon US" width={1600} height={520} loading="eager" decoding="async" className="h-auto w-full" /><span id="amazon-trending-now-heading" className="sr-only">Trending Now</span></a></section>
