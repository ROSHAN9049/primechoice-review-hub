  ...
  component: () => (
    <ResourceManager
      ...
      fields={[
        ...
        {
          name: "images",
          label: "Gallery (JSON array of image URLs/keys)",
          type: "json",
          default: "[]",
          help: '["https://example.com/product.jpg"]',
        },
        {
          name: "affiliate_links",
          label: "Affiliate links (JSON)",
          type: "json",
          default: DIGISTORE_DEFAULT,
          help: 'Digistore24: enter the productId; affiliateId is already set to ROSHANpratibha. Example: [{"network":"digistore24","productId":"123456","affiliateId":"ROSHANpratibha","campaignKey":"site","enabled":true}]',
        },
