...
import { AffiliateProductImporter } from "@/components/admin/AffiliateProductImporter";
    ...
    <div className="space-y-6">
      ...
      <ResourceManager
        ...
        fields={[
          ...
          { name: "affiliate_links", label: "Affiliate links (JSON)", type: "json", default: DIGISTORE_DEFAULT, help: "Amazon and Digistore24 affiliate links are supported." },
