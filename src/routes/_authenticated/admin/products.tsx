...
export const Route = createFileRoute("/_authenticated/admin/products")({
  component: () => (
    <ResourceManager
      table="products"
      title="Products"
      description="Paste one affiliate/product link, then quickly add price and image before publishing."
      labelField="title"
      fields={[
        ...
        { name: "images", label: "Product Image URL", type: "json", default: "[]", help: "Paste one direct image URL. Example: [\"https://example.com/product.jpg\"]" },
