...
const softwareImageUrl = "/software-digital-marketing.svg";
      ...
      <ul className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3" aria-label="Product review categories">
        {categories.map((c) => {
          ...
          const categoryVisual = c.slug === "health-supplements" ? (
            ...
            <img src={softwareImageUrl} alt="Digital Marketing Strategy & Tactics book cover for Software category" width={96} height={96} loading="lazy" decoding="async" className="size-20 shrink-0 rounded-lg bg-secondary object-cover p-1 sm:size-24" />
          ) : (
