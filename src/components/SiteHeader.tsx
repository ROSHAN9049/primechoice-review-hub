...
export function SiteHeader() {
  ...
  return (
    <>
      <style>{'[aria-label="Product review categories"] > li:nth-child(2) > a > span.grid { width: 6rem !important; height: 6rem !important; background-image: url("https://covers.openlibrary.org/b/isbn/9780849391255-L.jpg") !important; background-size: cover !important; background-position: center !important; background-repeat: no-repeat !important; } [aria-label="Product review categories"] > li:nth-child(2) > a > span.grid > svg { display: none !important; }'}</style>
