...
/**
 * Adds the correct Amazon Associates tag to a normal Amazon.in/Amazon.com URL.
 * Existing Amazon tag parameters are replaced so the site's configured IDs win.
